...
client_class_setup(lua_State *L)
{
    ...
    const lua_class_property_t properties[] = {
        ...
        {
            .name = "composite",
            .new = (lua_class_propfunc_t) luaA_client_set_composite,
            .index = (lua_class_propfunc_t) luaA_client_get_composite,
            .newindex = (lua_class_propfunc_t) luaA_client_set_composite,
        },
        {
            .name = "shape_bounding",
        ...
        {
            .name = "client_container_shape",
            .new = (lua_class_propfunc_t) luaA_client_set_container_shape,
            .index = (lua_class_propfunc_t) luaA_client_get_container_shape,
            .newindex = (lua_class_propfunc_t) luaA_client_set_container_shape,
        },
        {
            .name = "startup_id",
